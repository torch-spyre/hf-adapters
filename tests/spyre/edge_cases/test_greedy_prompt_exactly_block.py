...
"""Prompt length == BLOCK_SIZE (block boundary at prompt end)."""
...
def test_greedy_prompt_exactly_block(model_key):
    run_greedy_case(model_key, targets=[BLOCK_SIZE], max_new_tokens=16)
