...
"""Two expansions + partial (max_new_tokens = 2*BLOCK_SIZE + 5)."""
...
def test_greedy_short_two_blocks_plus(model_key):
    run_greedy_case(model_key, targets=[5], max_new_tokens=2 * BLOCK_SIZE + 5)
