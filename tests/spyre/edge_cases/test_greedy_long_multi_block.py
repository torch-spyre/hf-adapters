...
"""Prompt longer than one block (target=2*BLOCK_SIZE)."""
...
def test_greedy_long_multi_block(model_key):
    run_greedy_case(model_key, targets=[2 * BLOCK_SIZE], max_new_tokens=16)
